...
@section('conten-title', 'Feedback san pham')
@section('content')
            ...
            <div class="row">
                <div class="col-lg-8 mb-5 mb-lg-0">
                    <div class="form-title">
                        <h2>Chúng tôi rất cần những đóng góp của bạn</h2>
                        <div>
                    ...
                    <div class="contact-form">
                        <form method="POST" action="{{ route('client.storeFeedback') }}" enctype="multipart/form-data"
                            id="fruitkha-contact">
                            @csrf
                            <p>
                                <input type="text" placeholder="Tên khách hàng" value="{{ Auth::user()->name }}"
                                    name="name_user" id="name">
